...
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('My friend is at risk of eviction, anyone aware of any organisations that can help her in regard to the Serco evictions?','2019-04-11',ARRAY['english','immigration'],false,4,5);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('When interviewing arrivals seeking entry, what questions do UK Immigration offices ask?','2019-03-12',ARRAY['english','immigration'],false,2,4);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Does anyone know where I can find a good halal shop? I live in the south side but can travel.  ','2019-04-13',ARRAY['english','halal','food'],false,0,3);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Is there a Romanian Orthodox Church in Glasgow?','2019-04-14',ARRAY['english','visa'],false,0,1);
...
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('My kids have seen a photo of an amusement/waterpark and are pestering me to take them there, is there one close to Glasgow? ','2019-04-16',ARRAY['english','family'],false,0,4);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Stie cineva unde pot gasi zacusca?','2019-04-17',ARRAY['romanian','food'],false,0,2);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Where can I exchange Egyptian pounds to sterling?','2019-04-18',ARRAY['english','currency'],false,0,3);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('¿Alguien sabe qué es Council Tax y por qué hay que pagarlo?','2019-04-19',ARRAY['spanish','council-tax'],false,0,5);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Feeling homesick for my favourite food! Any good East African restaurants in Glasgow?','2019-04-20',ARRAY['english','food'],false,0,4);
INSERT INTO questions (content,date_posted,tags,is_answered,score,user_id) values('Can I bring my spouse to my GP appointment?','2019-04-20',ARRAY['english','doctor'],false,0,1);

INSERT INTO answers (content,date_answered,tags,is_accepted,score,question_id,user_id) values('Contact Unity Centre, they should be able to help. ','2019-12-10','',false,4,1,1);
INSERT INTO answers (content,date_answered,tags,is_accepted,score,question_id,user_id) values('Definitely contact the press as well, publicity can help. ','2019-04-21','',false,2,1,2);
INSERT INTO answers (content,date_answered,tags,is_accepted,score,question_id,user_id) values('Contacting your MP can help as well: https://www.theyworkforyou.com/mp/','2019-07-27','',false,2,1,3);
